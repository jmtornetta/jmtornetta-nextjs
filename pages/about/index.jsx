...
export default function About() {
    return (
        <Layout title="About">
            ...
            <section id="interests" className="flex flex-col items-start justify-end md:flex-row">
                ...
                <div className="mt-4 md:m-2 min-w-[180px] h-[50vh] relative overflow-hidden rounded-md shadow-md shadow-gray-600">
