          ...
          <div className="px-2 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="flex items-center justify-center flex-1 sm:items-stretch sm:justify-start">
                ...
                <div id="navbar" className="hidden sm:block sm:ml-6 lg:ml-16">
              ...
              <div id="icons-container" className="absolute inset-y-0 right-0 flex items-center gap-1 pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                {/* Hide bell icon until I start blogging */}
                {/* <button
                  type="button"
                  className="p-1 rounded-full text-olive-300 bg-brown-800 hover:text-brown-800 hover:bg-olive-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
                >
                  <span className="sr-only">View notifications</span>
                  <BellIcon className="w-6 h-6" aria-hidden="true" />
                </button> */}
                <a id="profile-email" href="#" target="_blank" className="p-1 rounded-full text-olive-300 bg-brown-800 hover:text-brown-800 hover:bg-olive-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
